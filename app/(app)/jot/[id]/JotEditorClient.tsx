...
export default function JotEditorClient({ jotting }: Props) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-neutral-900">
      <div className="border-b border-neutral-200 dark:border-neutral-800 px-6 py-3 flex items-center gap-4">
        <Link
          href="/jot"
      ...
      <div className="flex flex-1 flex-col" style={{ height: 'calc(100vh - 53px)' }}>
        <FreeEditor
