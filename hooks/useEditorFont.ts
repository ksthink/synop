...
export const FONT_OPTIONS: { value: EditorFont; label: string; family: string }[] = [
  ...
  { value: 'mulmaru',      label: '물마루',     family: "'Mulmaru', var(--font-nanum-gothic), sans-serif" },
  { value: 'kopub',        label: '코퍼브바탕', family: "'KoPubBatang', var(--font-nanum-gothic), sans-serif" },
  { value: 'iyagi',        label: '이야기',     family: "'IyagiGGC', var(--font-nanum-gothic), sans-serif" },
]
